...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "stable"
  WORKING_DIRECTORY "/Users/amitjoshi2724/Desktop/linear-time-weighted-job-scheduling/build/_deps/pybind11-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: stable")
    return()
  endif()
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/amitjoshi2724/Desktop/linear-time-weighted-job-scheduling/build/_deps/pybind11-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/amitjoshi2724/Desktop/linear-time-weighted-job-scheduling/build/_deps/pybind11-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
